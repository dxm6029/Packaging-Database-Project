...
public class PaymentGen {
	...
	public static void init() {
		...
		pay_matrix = Status.setFromArrayRandomly(2, new String[]{"Contract", "Credit Card", "Prepaid"}, pay_matrix);
		pay_matrix = Packages.genSimpleInt(3, 10, 1000, pay_matrix);
		pay_matrix = Status.setFromArrayRandomly(4, new String[]{"1/1/2019", "2/2/2019", "3/3/2019", "4/3/2019",
		...
		pay_matrix = Status.setFromArrayRandomly(6, new String[] {"Allan", "Aaron", "Matt", "Ben", "Josh", "Joel", "Michael", "Ryan",
				"Brian", "Ricky", "Rick", "Patrick", "Kevin", "Noah", "Felix", "Isaiah"}, pay_matrix);
		pay_matrix = Packages.genSimpleInt(7, 100, 999, pay_matrix);
		pay_matrix = Status.setFromArrayRandomly(8, new String[]{"1/1/2020", "2/2/2021", "3/3/2020", "4/3/2021",
				"5/6/2020", "7/9/2020", "4/2/2020", "12/23/2021", "3/25/2020", "6/30/2021", "10/9/2020", "9/10/2021",
				"4/3/2020", "3/6/2021", "4/20/2021"}
				, pay_matrix);
		pay_matrix = Status.setFromArrayRandomly(9, new String[] {"no"}, pay_matrix);
