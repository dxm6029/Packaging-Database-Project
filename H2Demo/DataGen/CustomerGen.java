...
public class CustomerGen {
	...
	public static void init() {
		...
		c_matrix = StatusGen.setFromArrayRandomly(3, new String[] {"xXmetallicaFan1992Xx", "pdefran", "adsdf", "password1", "helloWorld",
				"qedoffifa", "ehofallat", "oduderrac", "issecosa"},
				c_matrix);
		c_matrix = Packages.genSimpleInt(4, 1, 100, c_matrix);
		c_matrix = StatusGen.setFromArrayRandomly(5, new String[] {"gmail.com", "rit.edu", "yahoo.com", "ymail.com"}, c_matrix);
		c_matrix = Packages.genSimpleInt(6, 1111111111, Integer.MAX_VALUE, c_matrix);
		c_matrix = Packages.genSimpleInt(7, 1, 9999, c_matrix);
		c_matrix = StatusGen.setFromArrayRandomly(8, new String[] {"Jefferson Ave.", "Harrison St.", "James Ct.",
		...
		c_matrix = StatusGen.setFromArrayRandomly(10, new String[] {"Wantaugh","Massapequa","Copaigue","Quogue","Amagansett","Northampton",
				"Commack", "Hauppague", "Speonk", "Mattituck", "Sagaponack", "Wyandanch", "Ronkonkoma", "Yaphank"},c_matrix);
		c_matrix = StatusGen.setFromArrayRandomly(11, new String[] {"New York", "New Jersey", "Maine", "Delaware", "Pennsylvania",
